...
public class Telaexplorar extends AppCompatActivity implements View.OnClickListener {
    // parte 1
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telaexplorar);
        ...
        b10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent aq =new Intent(Telaexplorar.this,Explorar.class);
                startActivity(aq);
        ...
        botaomenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent aq =new Intent(Telaexplorar.this,Menuprincipal.class);
                startActivity(aq);
