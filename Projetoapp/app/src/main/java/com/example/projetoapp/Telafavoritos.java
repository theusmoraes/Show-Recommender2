...
public class Telafavoritos extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telafavoritos);
        ...
        b10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent aq =new Intent(Telafavoritos.this,Explorar.class);
                startActivity(aq);
        ...
        botaomenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent aq =new Intent(Telafavoritos.this,Menuprincipal.class);
                startActivity(aq);
